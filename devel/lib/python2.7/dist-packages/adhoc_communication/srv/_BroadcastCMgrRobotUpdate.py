...
"""autogenerated by genpy from adhoc_communication/BroadcastCMgrRobotUpdateRequest.msg. Do not edit."""
import sys
...
class BroadcastCMgrRobotUpdateRequest(genpy.Message):
  _md5sum = "3bebbc6c00d47ea04f96af1cfc986a55"
  _type = "adhoc_communication/BroadcastCMgrRobotUpdateRequest"
...
float32 z
"""
  __slots__ = ['topic','update','hop_limit']
  _slot_types = ['string','adhoc_communication/CMgrRobotUpdate','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BroadcastCMgrRobotUpdateRequest, self).__init__(*args, **kwds)
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from adhoc_communication/BroadcastCMgrRobotUpdateResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class BroadcastCMgrRobotUpdateResponse(genpy.Message):
  _md5sum = "284aa12dd9e9e760802ac9f38036ea5e"
  _type = "adhoc_communication/BroadcastCMgrRobotUpdateResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BroadcastCMgrRobotUpdateResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class BroadcastCMgrRobotUpdate(object):
  _type          = 'adhoc_communication/BroadcastCMgrRobotUpdate'
  _md5sum = '4f803d834e6e3f0165ecc26babd1f3f1'
  _request_class  = BroadcastCMgrRobotUpdateRequest
  _response_class = BroadcastCMgrRobotUpdateResponse
