...
"""autogenerated by genpy from nav2d_navigator/LocalizeActionFeedback.msg. Do not edit."""
import sys
...
class LocalizeActionFeedback(genpy.Message):
  ...
  _type = "nav2d_navigator/LocalizeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nav2d_navigator/LocalizeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = nav2d_navigator.msg.LocalizeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nav2d_navigator.msg.LocalizeFeedback()
