...
"""autogenerated by genpy from nav2d_navigator/LocalizeActionResult.msg. Do not edit."""
import sys
...
class LocalizeActionResult(genpy.Message):
  ...
  _type = "nav2d_navigator/LocalizeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nav2d_navigator/LocalizeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = nav2d_navigator.msg.LocalizeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nav2d_navigator.msg.LocalizeResult()
