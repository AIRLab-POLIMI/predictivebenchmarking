...
"""autogenerated by genpy from nav2d_navigator/GetFirstMapActionFeedback.msg. Do not edit."""
import sys
...
class GetFirstMapActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "nav2d_navigator/GetFirstMapActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nav2d_navigator/GetFirstMapFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetFirstMapActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = nav2d_navigator.msg.GetFirstMapFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nav2d_navigator.msg.GetFirstMapFeedback()
