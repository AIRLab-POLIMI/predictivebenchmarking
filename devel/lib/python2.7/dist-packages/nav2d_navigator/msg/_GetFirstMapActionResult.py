...
"""autogenerated by genpy from nav2d_navigator/GetFirstMapActionResult.msg. Do not edit."""
import sys
...
class GetFirstMapActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "nav2d_navigator/GetFirstMapActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nav2d_navigator/GetFirstMapResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetFirstMapActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nav2d_navigator.msg.GetFirstMapResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nav2d_navigator.msg.GetFirstMapResult()
