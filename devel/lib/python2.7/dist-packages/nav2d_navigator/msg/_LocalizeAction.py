...
"""autogenerated by genpy from nav2d_navigator/LocalizeAction.msg. Do not edit."""
import sys
...
class LocalizeAction(genpy.Message):
  _md5sum = "c6b44763ef96b288abc7dd265b2d5353"
  _type = "nav2d_navigator/LocalizeAction"
...
"""
  ...
  _slot_types = ['nav2d_navigator/LocalizeActionGoal','nav2d_navigator/LocalizeActionResult','nav2d_navigator/LocalizeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = nav2d_navigator.msg.LocalizeActionGoal()
      if self.action_result is None:
        self.action_result = nav2d_navigator.msg.LocalizeActionResult()
      if self.action_feedback is None:
        self.action_feedback = nav2d_navigator.msg.LocalizeActionFeedback()
    else:
      self.action_goal = nav2d_navigator.msg.LocalizeActionGoal()
      self.action_result = nav2d_navigator.msg.LocalizeActionResult()
      self.action_feedback = nav2d_navigator.msg.LocalizeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_goal.goal.velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
