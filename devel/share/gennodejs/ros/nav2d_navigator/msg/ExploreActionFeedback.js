...
class ExploreActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExploreFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExploreActionFeedback(null);
    ...
    data.feedback = ExploreFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExploreActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExploreFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExploreFeedback()
    }
