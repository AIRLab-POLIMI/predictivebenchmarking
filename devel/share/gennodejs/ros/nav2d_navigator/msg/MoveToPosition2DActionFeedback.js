...
let MoveToPosition2DFeedback = require('./MoveToPosition2DFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class MoveToPosition2DActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MoveToPosition2DFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveToPosition2DFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveToPosition2DActionFeedback(null);
    ...
    data.feedback = MoveToPosition2DFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToPosition2DActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveToPosition2DFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveToPosition2DFeedback()
    }
...
module.exports = MoveToPosition2DActionFeedback;
