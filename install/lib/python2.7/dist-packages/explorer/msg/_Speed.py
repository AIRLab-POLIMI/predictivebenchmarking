...
class Speed(genpy.Message):
  _md5sum = "ab71c17b247789c29752d16cf36898a8"
  _type = "explorer/Speed"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32 avg_speed
"""
  __slots__ = ['avg_speed']
  _slot_types = ['float32']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_f().pack(self.avg_speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.avg_speed,) = _get_struct_f().unpack(str[start:end])
      return self
