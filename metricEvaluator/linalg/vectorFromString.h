...
#ifndef VECTOR_FROM_STRING_H
#define VECTOR_FROM_STRING_H

/** @addtogroup linalg_utils liblinalg_utils **/
// @{
/** \file vectorFromString.h
 * \brief parse a string and return a vector
 **/

#include "vector.h"

/**
 * parse Vector from a string which is produced with the cout << operator.
